...
import movie.software.com.spax.adapter.CastDetailsSlideAdapter;
...
public class CastDetails extends Fragment implements ObservableScrollViewCallbacks {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        GlobalClass.setCurrentFragment("CastDetailsFragment");
                        ...
                        for (int i = 0; i < simLen; i++) {
                            ...
                            if (isAdded()) {
                                if (movieListNoDuplicates.get(i).getPosterPath() != null)
                                    ...
                                    simMov.setPosterPath(movieListNoDuplicates.get(i).getPosterPath());
                            }
