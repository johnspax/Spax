...
import movie.software.com.spax.activities.SampleActivityBase;
import movie.software.com.spax.adapter.GoogleDirectionAPI;
import movie.software.com.spax.logger.Log;

public class MapSearchActivity extends SampleActivityBase
    ...
    private static final LatLngBounds BOUNDS_GREATER_SYDNEY = new LatLngBounds(
            new LatLng(-4.675403, 34.036245), new LatLng(4.213752, 41.488813));//Kenya
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GlobalClass.setCurrentFragment("MapFragment");
            ...
            MainActivity Fa = new MainActivity();
        ...
        // Set up the 'Go' Button to navigate
