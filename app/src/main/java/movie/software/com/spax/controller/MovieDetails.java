...
import movie.software.com.spax.adapter.MovieDetailsSlideAdapter;
import movie.software.com.spax.helper.ObservableScrollViewCallbacks;
import movie.software.com.spax.helper.ScrollState;
import movie.software.com.spax.helper.Scrollable;
import movie.software.com.spax.model.CastModel;
import movie.software.com.spax.model.SimilarModel;
import movie.software.com.spax.view.MovieDetailsSlidingTabLayout;
import movie.software.com.spax.view.ObservableParallaxScrollView;
...
public class MovieDetails extends Fragment implements ObservableScrollViewCallbacks {
    ...
    private CircledImageView addToCart;
    private FloatingActionButton fabCart;
    private onCartIconClick onCartIconClick;
    private onFabCartIconClick onFabCartIconClick;
    private ViewCartList viewCartList;
    private CoordinatorLayout coordinatorLayout;
    private int MovieCartSize;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        GlobalClass.setCurrentFragment("MovieDetailsFragment");
        //I decided to get my cart from here, Coz I really need to get the size of it
        ...
        PosterPath = GlobalClass.getPosterPath();
        ...
        onCartIconClick = new onCartIconClick();
        ...
        addToCart.setOnClickListener(onCartIconClick);
        ...
        public void onClick(View v) {
            ...
            if (!key) {
                ...
                if (currPos == 0) {
                    ...
                    movieDetailsInfo.getAddToCart().setVisibility(View.VISIBLE);
                    movieDetailsInfo.getAddToCart().bringToFront();
                    movieDetailsInfo.getFabCart().setVisibility(View.VISIBLE);
                    movieDetailsInfo.getFabCount().setVisibility(View.VISIBLE);
                    fabCart.setVisibility(View.INVISIBLE);
                    fabCount.setVisibility(View.INVISIBLE);
                } else {
                    ...
                    addToCart.bringToFront();
                    movieDetailsInfo.getFabCart().setVisibility(View.INVISIBLE);
                    movieDetailsInfo.getFabCount().setVisibility(View.INVISIBLE);
                ...
                if (currPos == 0) {
                    ...
                    movieDetailsInfo.getAddToCart().setVisibility(View.INVISIBLE);
                    movieDetailsInfo.getAddToCart().bringToFront();
                    movieDetailsInfo.getFabCart().setVisibility(View.INVISIBLE);
                    movieDetailsInfo.getFabCount().setVisibility(View.INVISIBLE);
                    fabCart.setVisibility(View.INVISIBLE);
    ...
    /**
     * Class which listens when the user has tapped on Cart icon button.
     */
    public class onCartIconClick implements View.OnClickListener {
        ...
        @Override
        public void onClick(View v) {
            final String strTitle = movieDetailsInfo.getTitleText().getText().toString();
            final String strDate = movieDetailsInfo.getReleaseDate().getText().toString();
            ...
            try {
                ...
                if (MovieCartJson.equals("")) {
                    obj1.put("Title", strTitle);
                    obj1.put("Date", strDate);
                    obj1.put("MovieID", MovieID);
                    obj1.put("PosterPath", PosterPath);
                    req.put(obj1);
                    obj2.put("data", req);
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if (jsonObject.optString("Title").toString().equals(strTitle)) {
                            isInList = true;
                            showToastFromBackground(strTitle + " is already in the cart!");
                        }
                    }
                    if (isInList == false) {
                        jsonArray.put(obj1);
                ...
                if (isInList == false) {
                    ...
                    movieDetailsInfo.getFabCount().setText(dumbAssPage);
                    Snackbar snackbar = Snackbar
                            .make(coordinatorLayout, strTitle + " added to cart", 5000)
                            .setAction("UNDO", new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    try {
                                        ...
                                        movieDetailsInfo.getFabCount().setText(String.valueOf(jsonArray.length()));
                                    } catch (JSONException e) {
                                        e.printStackTrace();
                                    }
                                    Snackbar snackbar1 = Snackbar.make(coordinatorLayout, strTitle + " removed from cart", Snackbar.LENGTH_SHORT);
                                    snackbar1.show();
                                }
                            });
                    snackbar.show();
    ...
    /**
     * Class which listens when the user has tapped on Fab icon button.
     */
    public class onFabCartIconClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(getActivity());
            if (!prefs.getString("MovieCart", "").equals("")) {
    ...
    public class onTrailerIconClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (trailerList.size() == 1) {
                ...
                intent.putExtra("YoutubeURL", MovieDB.youtube + trailerList.get(0));
    ...
    public onCartIconClick getOnCartIconClick() {
        return onCartIconClick;
    }

    public onFabCartIconClick getOnFabCartIconClick() {
        return onFabCartIconClick;
    }

    public TextView getFabCount() {
        return fabCount;
    }
    ...
    public void onDestroyView() {
        ...
        onCartIconClick = null;
        onFabCartIconClick = null;
        onPageChangeSelected = null;
