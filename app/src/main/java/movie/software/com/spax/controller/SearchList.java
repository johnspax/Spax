...
import movie.software.com.spax.adapter.SearchAdapter;
import movie.software.com.spax.model.MovieModel;
import movie.software.com.spax.model.SearchModel;
 ...
 */
public class SearchList extends Fragment implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        GlobalClass.setCurrentFragment("SearchFragment");
    ...
    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        try {
            ...
            if (MovieCartJson.equals("")) {
                obj1.put("Title", searchList.get(position).getTitle());
                obj1.put("Date", searchList.get(position).getReleaseDate());
                obj1.put("MovieID", searchList.get(position).getId());
                obj1.put("PosterPath", searchList.get(position).getPosterPath());
                req.put(obj1);
                obj2.put("data", req);
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if(jsonObject.optString("Title").toString().equals(searchList.get(position).getTitle())){
                        isInList = true;
                        showToastFromBackground(searchList.get(position).getTitle() + " is already in the cart!");
                    }
                }
                if(isInList == false) {
                    jsonArray.put(obj1);
            ...
            if(isInList == false){
                ...
                Snackbar snackbar = Snackbar
                        .make(coordinatorLayout, searchList.get(position).getTitle() + " added to cart", 5000)
                        .setAction("UNDO", new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Snackbar snackbar1 = Snackbar.make(coordinatorLayout, searchList.get(moviePos).getTitle() + " removed from cart", Snackbar.LENGTH_SHORT);
                                snackbar1.show();
                            }
                        });
                snackbar.show();
