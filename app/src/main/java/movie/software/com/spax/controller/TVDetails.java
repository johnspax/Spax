...
import movie.software.com.spax.adapter.TVDetailsSlideAdapter;
...
import movie.software.com.spax.model.SeasonModel;
...
public class TVDetails extends Fragment implements ObservableScrollViewCallbacks {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        GlobalClass.setCurrentFragment("TvDetailsFragment");
        ...
        public void onClick(View v) {
            ...
            if (!key) {
                ...
                if (currPos == 0) {
                    ...
                    tvDetailsInfo.getAddToCart().setVisibility(View.VISIBLE);
                    tvDetailsInfo.getAddToCart().bringToFront();
                    tvDetailsInfo.getFabCart().setVisibility(View.VISIBLE);
                    tvDetailsInfo.getFabCount().setVisibility(View.VISIBLE);
                    fabCart.setVisibility(View.INVISIBLE);
                    fabCount.setVisibility(View.INVISIBLE);
                } else {
                    ...
                    addToCart.bringToFront();
                    tvDetailsInfo.getFabCart().setVisibility(View.INVISIBLE);
                    tvDetailsInfo.getFabCount().setVisibility(View.INVISIBLE);
                ...
                if (currPos == 0) {
                    ...
                    tvDetailsInfo.getAddToCart().setVisibility(View.INVISIBLE);
                    tvDetailsInfo.getAddToCart().bringToFront();
                    tvDetailsInfo.getFabCart().setVisibility(View.INVISIBLE);
                    tvDetailsInfo.getFabCount().setVisibility(View.INVISIBLE);
                    fabCart.setVisibility(View.INVISIBLE);
    ...
    public class onCartIconClick implements View.OnClickListener {
        ...
        @Override
        public void onClick(View v) {
            final String strTitle = tvDetailsInfo.getTitle().getText().toString();
            final String strDate = tvDetailsInfo.getFirstAirDateText().getText().toString();
            ...
            try {
                ...
                if (isInList == false) {
                    ...
                    tvDetailsInfo.getFabCount().setText(dumbAssPage);
                            ...
                            .setAction("UNDO", new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    try {
                                        ...
                                        tvDetailsInfo.getFabCount().setText(String.valueOf(jsonArray.length()));
                                    } catch (JSONException e) {
                                        e.printStackTrace();
                                    }
