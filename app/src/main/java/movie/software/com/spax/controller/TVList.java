 ...
 */
public class TVList extends Fragment implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        GlobalClass.setPosterPath(tvList.get(position).getPosterPath());
    ...
    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        try {
            ...
            MovieCartJson = prefs.getString("MovieCart", "");
            if (MovieCartJson.equals("")) {
                obj1.put("Title", tvList.get(position).getTitle());
                obj1.put("Date", tvList.get(position).getReleaseDate());
                obj1.put("MovieID", tvList.get(position).getId());
                req.put(obj1);
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if(jsonObject.optString("Title").toString().equals(tvList.get(position).getTitle())){
                        isInList = true;
                        showToastFromBackground(tvList.get(position).getTitle() + " is already in the cart!");
                    }
                }
                if(isInList == false) {
                    jsonArray.put(obj1);
            ...
            if(isInList == false) {
                ...
                Snackbar snackbar = Snackbar
                        .make(coordinatorLayout, tvList.get(position).getTitle() + " added to cart", 5000)
                        .setAction("UNDO", new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Snackbar snackbar1 = Snackbar.make(coordinatorLayout, tvList.get(moviePos).getTitle() + " removed from cart", Snackbar.LENGTH_SHORT);
                                snackbar1.show();
                            }
                        });
                snackbar.show();
