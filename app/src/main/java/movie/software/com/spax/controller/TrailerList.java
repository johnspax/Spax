...
import movie.software.com.spax.adapter.TrailerAdapter;
import movie.software.com.spax.model.TrailerModel;
...
public class TrailerList extends Fragment implements AdapterView.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        GlobalClass.setCurrentFragment("TrailerListFragment");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        intent.putExtra("YoutubeURL", MovieDB.youtube + trailerPath.get(position));
